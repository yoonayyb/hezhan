<template>
  <div>
    <el-dialog title="补充材料" :visible.sync="dialogVisible" width="80%" :before-close="handleClose" :close-on-click-modal="false">
      <!-- <span>这是一段信息</span> -->
      <div style="text-align: left;min-height: 77vh;" v-loading="loadStatus">
          <div slot="reference">
            <h2 v-if="showAddBtn" style="margin-top: 10px">
              ...
              第
              <span style="color:blue" v-text="org_sn"></span>
              次就诊
            </h2>
...
import medicalRecord from '@/components/business/ElectronicMedicalRecord/indexIII.vue'
