<template>
  <div>
    <el-dialog title="补充材料"
               :visible.sync="dialogVisible"
               width="80%"
               :before-close="handleClose"
               :close-on-click-modal="false">
      <!-- <span>这是一段信息</span> -->
      <div style="text-align: left;min-height: 77vh;"
           v-loading="loadStatus">
        <div slot="reference">
          <h2 v-if="showAddBtn"
              style="margin-top: 10px">
            <span v-text="patient_recordinfo.pname"></span> 在
            <span v-text="patient_recordinfo.hname"></span>
            第
            <span style="color:blue"
                  v-text="org_sn"></span>
            次就诊
          </h2>
          <!-- <h2>新增病历基本信息：<el-button
                type="primary"
                size="small"
        ...
        <!-- <div style="margin-top: 20px">
          <h3 style="margin-top: 10px" v-if="showAddBtn">
            上传文件：
            <el-button
              type="primary"
              size="small"
        ...
        <div>
          <medicalRecord @toaddMRecord='toAddRecord'
                         :patient_recordinfo="patient_recordinfo"
                         :id="patientId"
                         :tabs="tabs"
                         :applyId="applyID"
                         ref="medicalRecord"
                         v-if="showAddBtn"></medicalRecord>
        </div>
      </div>

      <span slot="footer"
            class="dialog-footer">
        <el-button :disabled='loadStatus'
                   type="success"
                   @click="submitdataForm"
                   v-if="showAddBtn">保存</el-button>
        <el-button @click="handleClose">关 闭</el-button>
      </span>
    </el-dialog>
    <!-- <checkRecord :id="patientId" ref="checkRecord"></checkRecord> -->
    <el-dialog style="padding: 10px"
          ...
          <el-col :span="6"
            ...
            <div>
              <el-button type="primary"
                         ...
                         style="margin: 10px;width:150px">{{ item.name }}</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrCourseRecord :doctorTitle="doctorTitle"
                            :name="this.patient_recordinfo.pname"
                            :patient_recordinfo="patient_recordinfo"
                            :patientID="this.patientId"
                            @listentochild="showmsgfromchild"></addEmrCourseRecord>
      </div>
      <span class="dialog-footer"
            slot="footer">
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrPatient :patientID="this.patientId"
                       @listentochild="showmsgfromchild"></addEmrPatient>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addFristRecord :doctorTitle="doctorTitle"
                        :name="this.patient_recordinfo.pname"
                        :patient_recordinfo="patient_recordinfo"
                        :patientID="this.patientId"
                        @listentochild="showmsgfromchild"></addFristRecord>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrDaily :doctorTitle="doctorTitle"
                     :name="this.patient_recordinfo.pname"
                     :patient_recordinfo="patient_recordinfo"
                     :patientID="this.patientId"
                     @listentochild="showmsgfromchild"></addEmrDaily>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrWard :doctorTitle="doctorTitle"
                    :name="this.patient_recordinfo.pname"
                    :patient_recordinfo="patient_recordinfo"
                    :patientID="this.patientId"
                    @listentochild="showmsgfromchild"></addEmrWard>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordShfit :doctorTitle="doctorTitle"
                        :name="this.patient_recordinfo.pname"
                        :patient_recordinfo="patient_recordinfo"
                        :patientID="this.patientId"
                        @listentochild="showmsgfromchild"></addRecordShfit>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordSuccession :doctorTitle="doctorTitle"
                             :name="this.patient_recordinfo.pname"
                             :patient_recordinfo="patient_recordinfo"
                             :patientID="this.patientId"
                             @listentochild="showmsgfromchild"></addRecordSuccession>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordDischarge :doctorTitle="doctorTitle"
                            :name="this.patient_recordinfo.pname"
                            :patient_recordinfo="patient_recordinfo"
                            :patientID="this.patientId"
                            @listentochild="showmsgfromchild"></addRecordDischarge>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordOut :doctorTitle="doctorTitle"
                      :name="this.patient_recordinfo.pname"
                      :patient_recordinfo="patient_recordinfo"
                      :patientID="this.patientId"
                      @listentochild="showmsgfromchild"></addRecordOut>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordIn :doctorTitle="doctorTitle"
                     :name="this.patient_recordinfo.pname"
                     :patient_recordinfo="patient_recordinfo"
                     :patientID="this.patientId"
                     @listentochild="showmsgfromchild"></addRecordIn>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrRescue :doctorTitle="doctorTitle"
                      :name="this.patient_recordinfo.pname"
                      :patient_recordinfo="patient_recordinfo"
                      :patientID="this.patientId"
                      @listentochild="showmsgfromchild"></addEmrRescue>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrOp :doctorTitle="doctorTitle"
                  :name="this.patient_recordinfo.pname"
                  :patient_recordinfo="patient_recordinfo"
                  :patientID="this.patientId"
                  @listentochild="showmsgfromchild"></addEmrOp>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrPostOperative :doctorTitle="doctorTitle"
                             :name="this.patient_recordinfo.pname"
                             :patient_recordinfo="patient_recordinfo"
                             :patientID="this.patientId"
                             @listentochild="showmsgfromchild"></addEmrPostOperative>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordSummary :doctorTitle="doctorTitle"
                          :name="this.patient_recordinfo.pname"
                          :patient_recordinfo="patient_recordinfo"
                          :patientID="this.patientId"
                          @listentochild="showmsgfromchild"></addRecordSummary>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordOdituary :doctorTitle="doctorTitle"
                           :name="this.patient_recordinfo.pname"
                           :patient_recordinfo="patient_recordinfo"
                           :patientID="this.patientId"
                           @listentochild="showmsgfromchild"></addRecordOdituary>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordDiscussion :doctorTitle="doctorTitle"
                             :name="this.patient_recordinfo.pname"
                             :patient_recordinfo="patient_recordinfo"
                             :patientID="this.patientId"
                             @listentochild="showmsgfromchild"></addRecordDiscussion>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordPs :doctorTitle="doctorTitle"
                     :name="this.patient_recordinfo.pname"
                     :patient_recordinfo="patient_recordinfo"
                     :patientID="this.patientId"
                     @listentochild="showmsgfromchild"></addRecordPs>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordRopd :doctorTitle="doctorTitle"
                       :name="this.patient_recordinfo.pname"
                       :patient_recordinfo="patient_recordinfo"
                       :patientID="this.patientId"
                       @listentochild="showmsgfromchild"></addRecordRopd>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordOperation :doctorTitle="doctorTitle"
                            :name="this.patient_recordinfo.pname"
                            :patient_recordinfo="patient_recordinfo"
                            :patientID="this.patientId"
                            @listentochild="showmsgfromchild"></addRecordOperation>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordNursing :doctorTitle="doctorTitle"
                          :name="this.patient_recordinfo.pname"
                          :patient_recordinfo="patient_recordinfo"
                          :patientID="this.patientId"
                          @listentochild="showmsgfromchild"></addRecordNursing>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordOd :doctorTitle="doctorTitle"
                     :name="this.patient_recordinfo.pname"
                     :patient_recordinfo="patient_recordinfo"
                     :patientID="this.patientId"
                     @listentochild="showmsgfromchild"></addRecordOd>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addRecordDisDie :doctorTitle="doctorTitle"
                         :name="this.patient_recordinfo.pname"
                         :patient_recordinfo="patient_recordinfo"
                         :patientID="this.patientId"
                         @listentochild="showmsgfromchild"></addRecordDisDie>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
    ...
    <el-dialog :close-on-click-modal="false"
               ...
               width="1200px">
      <div>
        <addEmrCon :doctorTitle="doctorTitle"
                   :name="this.patient_recordinfo.pname"
                   :patient_recordinfo="patient_recordinfo"
                   :patientID="this.patientId"
                   @listentochild="showmsgfromchild"></addEmrCon>
      </div>
      <span class="dialog-footer"
            slot="footer">
        <el-button @click="Reflash_page">关 闭</el-button>
...
import medicalRecord from '@/components/business/ElectronicMedicalRecord/indexII.vue'
...
export default {
  ...
  created () {
    ...
    // 拿还未绑定的手录病历
    Bus.$on('getHandleReocrdList', target => {
      // console.log(target)
      this.RecordDict = Object.assign(this.RecordDict, target)
      // console.log(this.RecordDict)
      let RecordList = []
      for (var i in this.RecordDict) {
        if (this.RecordDict[i].length !== 0) {
          for (var i1 in this.RecordDict[i]) {
            RecordList.unshift(this.RecordDict[i][i1])
          }
          // RecordLis.push(this.RecordDict[i])
        }
      }
      // console.log(RecordLis)
      this.dataForm.emrRecordViewModel = RecordList
      // console.log(this.dataForm)
    })
    // 刷新就诊次数
  ...
  methods: {
    ...
    handleClose (done) {
      this.$confirm(
        '若您已经上传的病历文件，检验检查报告还未保存，关闭则会销毁，如果没有请忽略本条提示，是否确认关闭？',
        '提示',
        {
    ...
    showmsgfromchild (data) {
      ...
      //     this.openDialogFromChange(this.rowsave)
      //   })
      //   // this.getTypeinfo()
      //   // this.getTypeOfRecord()
      //   // document.body.style["overflow-y"] = "auto";
