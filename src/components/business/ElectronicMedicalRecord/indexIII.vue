<template>
  <div class="Mainbody" v-loading="loadStatus">
    <div style="text-align:right">
      ...
      <!-- <div v-if="tab === '手录病历'">
        <el-select v-model="value" placeholder="请选择需要新增的病历">
          <el-option
        ...
        <el-button type="primary" style="margin-left: 6px" @click="toAddRecord(value)">新增</el-button>
      </div>
      <div v-if="tab == '病历文件'">
        <el-button type="primary" style="margin-left: 6px" @click="showEmrFile">新增病历文件</el-button>
      </div> -->
      <div v-if="tab == '检查报告'">
        <el-button type="primary" @click="addPacsDialogVisible = true">新增检查报告</el-button>
      </div>
      <div v-if="tab === '检验报告'">
        <el-button type="primary" @click="addLisDialogVisible = true">新增检验报告</el-button>
      </div>
    </div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <!-- <el-tab-pane label="手录病历" name="first" :lazy='true' v-show="false">
        <ElectronicMedicalRecord @listenToMedical="listenFromPatient" :id="id" :applyId="applyId"></ElectronicMedicalRecord>
      </el-tab-pane> -->
      <!-- <el-tab-pane label="病历文件" name="second" v-if="showStatus" :lazy='true'>
        <EmrFile :patient_Id="id" :p_sn="p_sn" :datainfo="datainfo_emrFile"></EmrFile>
      </el-tab-pane> -->
      <el-tab-pane label="检查报告" name="third" v-if="showStatus" :lazy='true'>
        <Pacs :patient_Id="id" :pSn="p_sn" :datainfo="datainfo_Pacs"></Pacs>
      </el-tab-pane>
      <el-tab-pane label="检验报告" name="four" v-if="showStatus" :lazy='true'>
        <Lis :patient_Id="id" :pSn="p_sn" :datainfo="datainfo_Lis"></Lis>
      </el-tab-pane>
    </el-tabs>
    <edit ref="edit" :p_sn="p_sn" :patientID="id"></edit>
...
import { getListByApply, getBasePatient } from '@/api/index'
export default {
  props: {
    id: String,
    patient: Object,
