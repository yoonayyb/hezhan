  ...
  <el-container>
    ...
    <el-main>
      <el-table :data="tableData" border="" v-loading="loading" style="width: 100%">
        <el-table-column min-width="120px" prop="screen_time" label="日期" align="center">
        ...
        <el-table-column prop="systolic_pressure" label="收缩压" align="center"></el-table-column>
        <el-table-column prop="diastolic_pressure" label="舒张压" align="center"></el-table-column>
        <el-table-column prop="pulse" label="脉搏" align="center"></el-table-column>
    ...
    <hypertensionRecordDialog
      :visible="editModalVisible"
      ref="editwrapper"
      @upload="hypertensionRecord"
...
import hypertensionRecordDialog from "./dialog/hypertensionRecordDialog";
