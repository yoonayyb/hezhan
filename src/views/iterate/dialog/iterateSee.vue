<template>
  <el-container>
    <el-header style="height:auto">
      <el-page-header @back="back" content="迭代详情"></el-page-header>
    </el-header>
    <el-main>
      <el-row :gutter="10">
        <el-col :span="12">
...
<script>
import { getIterateDetail } from "@/api/modules/manbing.js";
...
export default {
  ...
  methods: {
    getIterateDetail() {
      let pramas = {
        iterateId: this.$route.params.Id
      };
      getIterateDetail(pramas).then(res => {
        console.log(res);
