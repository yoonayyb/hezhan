<template>
  <div style="padding-bottom: 80px">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{name:'deptAuth'}">账号权限</el-breadcrumb-item>
    </el-breadcrumb>
    <tree-table
      :data="treeTableData"
      :eval-args="args"
...
import { getMenuTreeByUser } from "@//api/index";
...
export default {
  ...
  methods: {
    ...
    async getMenuTree() {
      ...
      let menuTree = await getMenuTreeByUser({
        roleID: this.$route.query.userId
      });
