  ...
  <el-container>
    <el-header style="height:auto">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item>
          <el-input v-model="formInline.patientName" placeholder="输入关键词"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-main>
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="Name" label="需求名称" align="center"></el-table-column>
        <el-table-column prop="ProjectName" label="迭代名称" align="center"></el-table-column>
...
<script>
import { baseInformation } from "@/api/modules/manbing.js";
import InformationDialong from "../demand/dialog/informationDialog";
...
export default {
  ...
  methods: {
    ...
    handleClick(row, type) {
      if (type == "see") {
        this.$router.push({ name: "demandSee", params: { Id: row.Id } });
        return false;
      }
      this.editModalVisible = true;
      console.log(row);
